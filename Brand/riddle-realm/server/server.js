...
app.get(['/', '/landing', '/landing.html'], sendLanding);
app.get(['/play', '/app', '/arena', '/game'], sendApp);
...
async function start() {
  ...
  app.listen(PORT, HOST, () => {
    ...
    console.log(`Play:    http://127.0.0.1:${PORT}/play`);
    console.log(`Health: http://127.0.0.1:${PORT}/api/health`);
    console.log(`Owner:  http://127.0.0.1:${PORT}/founder.html`);
