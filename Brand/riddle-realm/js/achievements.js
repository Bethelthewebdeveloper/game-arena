...
const Achievements = (function () {
  ...
  const DEFS = [
    ...
    },
    {
      id: 'speed_demon',
      name: 'Speed Demon',
      description: 'Record a Reflex best under 280ms',
      emoji: '⚡',
      type: 'reflexBestMsInv',
      target: 1,
      reward: { xp: 40, coins: 20 }
    },
    {
      id: 'memory_master',
      name: 'Memory Master',
      description: 'Clear Memory in 16 moves or fewer',
      emoji: '🧠',
      type: 'memoryFewestInv',
      target: 1,
      reward: { xp: 40, coins: 20 }
    },
    {
      id: 'perfect_shootout',
      name: 'Perfect Shootout',
      description: 'Score every shot in a Penalty set',
      emoji: '⚽',
      type: 'penaltyPerfect',
      target: 1,
      reward: { xp: 40, coins: 20 }
    },
    {
      id: 'rps_streak',
      name: 'Winning Streak',
      description: 'Win 3 Rock Paper Scissors rounds in a row',
      emoji: '✊',
      type: 'rpsBestStreak',
      target: 3,
      reward: { xp: 30, coins: 15 }
    },
    {
      id: 'word_master',
      name: 'Word Master',
      description: 'Score 400+ in Word Clash',
      emoji: '🔤',
      type: 'wordBest',
      target: 400,
      reward: { xp: 40, coins: 20 }
    },
    {
      id: 'trivia_expert',
      name: 'Trivia Expert',
      description: 'Hit a Trivia streak of 4',
      emoji: '🎯',
      type: 'triviaBestStreak',
      target: 4,
      reward: { xp: 40, coins: 20 }
    },
    {
      ...
      description: 'Play 3 different Arena games',
      emoji: '🏟️',
      type: 'uniqueGames',
      target: 3,
      reward: { xp: 50, coins: 25 }
  ...
  function getPlayerMetric(type, player, extras) {
    ...
    if (extras && extras[type] != null) {
      return Number(extras[type]) || 0;
    }
    if (type === 'custom') {
